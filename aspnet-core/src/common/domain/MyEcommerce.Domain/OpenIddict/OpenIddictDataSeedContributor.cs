...
namespace MyEcommerce.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("MyEcommerce") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor
            {
                Name = "MyEcommerce",
                DisplayName = "MyEcommerce API",
                Resources = { "MyEcommerce" }
            });
        }

        if (await _openIddictScopeRepository.FindByNameAsync("MyEcommerce.Admin") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor
            {
                Name = "MyEcommerce.Admin",
                DisplayName = "MyEcommerce Admin API",
                Resources = { "MyEcommerce.Admin" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        adminScopes.Add("MyEcommerce.Admin");

        var clientScopes = new List<string>();
        clientScopes.AddRange(commonScopes);
        clientScopes.Add("MyEcommerce");

        var configurationSection = _configuration.GetSection("OpenIddict:Applications");

        // //Console Test / Angular Client
        // var consoleAndAngularClientId = configurationSection["MyEcommerce_App:ClientId"];
        // if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        // {
        //     var consoleAndAngularClientRootUrl = configurationSection["MyEcommerce_App:RootUrl"]?.TrimEnd('/');
        ...
        //Admin Client
        var webAdminClientId = configurationSection["MyEcommerce_Admin:ClientId"];
        if (!webAdminClientId.IsNullOrWhiteSpace())
        {
            var adminWebClientRootUrl = configurationSection["MyEcommerce_Admin:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
        ...
        //Web Client
        var webClientId = configurationSection["MyEcommerce_Web:ClientId"];
        if (!webClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["MyEcommerce_Web:RootUrl"]?.EnsureEndsWith('/');
            await CreateApplicationAsync(
                name: webClientId,
                type: OpenIddictConstants.ClientTypes.Confidential,
                consentType: OpenIddictConstants.ConsentTypes.Implicit,
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["MyEcommerce_Admin_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["MyEcommerce_Admin_Swagger:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
        ...
        // Swagger Client
        // var swaggerClientId = configurationSection["MyEcommerce_Swagger:ClientId"];
        // if (!swaggerClientId.IsNullOrWhiteSpace())
        // {
        //     var swaggerRootUrl = configurationSection["MyEcommerce_Swagger:RootUrl"]?.TrimEnd('/');
