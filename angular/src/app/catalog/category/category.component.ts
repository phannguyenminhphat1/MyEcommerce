...
@Component({
  ...
  providers: [CancelDialogService, ProductCategoriesService],
})
export class CategoryComponent implements OnInit, OnDestroy {
  ...
  showAddModal() {
    ...
    ref?.onClose.subscribe((data: ProductCategoryInListDto) => {
      if (data) {
        this.loadData();
        this.notificationService.showSuccess('Add cateogyr successfully');
        this.selectedItems = [];
      }
    });
  }
  ...
  showEditModal(id?: string) {
    ...
    ref?.onClose.subscribe((data: ProductCategoryInListDto) => {
      if (data) {
        this.loadData();
        this.notificationService.showSuccess('Edit category successfully');
        this.selectedItems = [];
      }
    });
  }
